"""
Mixture of discretized logistic distriubtions, copied from
...
class DiscretizedMixtureLogitsDistribution(Distribution):
    ...
    def log_prob(self, value):
        return -discretized_mix_logistic_loss(value * 2 - 1, self.logits).unsqueeze(
            1
        )  # add channel dim for compatibility with loss functions expecting bchw
