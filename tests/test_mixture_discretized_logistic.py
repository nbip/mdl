...
class TestMixtureDiscretized(unittest.TestCase):
    ...
    def test_pixels(self):
        ...
        loc, logscale, mix_logits = get_mixture_params(parameters=self.logits, x=2 * self.x - 1.)
        dist = PixelMixtureDiscretizedLogistic(loc, logscale, mix_logits, low=-1., high=1., levels=256.)
